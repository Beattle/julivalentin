          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="custommenu_description[<?php echo $language['language_id']; ?>][title]" size="100" value="<?php echo isset($custommenu_description[$language['language_id']]) ? $custommenu_description[$language['language_id']]['title'] : ''; ?>" />
         ...
         <table class="form">
			 ...
			 <tr><td><?php echo $entry_level1; ?></td>
			  <td> <select name="level1" >
				...
				<?php if($custommenu) { foreach($custommenu as $menu)
				{
				if($menu['custommenu_id']==$level1)
				{
				$sel="selected";
				}
				else
				...
				?>
				<option <?php echo $sel; ?> value="<?php echo $menu['custommenu_id'] ?>"><?php echo $menu['title'] ?></option> 
				<?php
				}}
				?>
			 ...
			 <tr><td><?php echo $entry_level2; ?></td>
			  <td> <select name="level2" >
				<option value=""><?php echo $text_select ?> </option> 
				<?php if($custommenu1) { foreach($custommenu1 as $menu)
				{
				if($menu['custommenu_id']==$level2)
				{
				$sel="selected";
				}
				else
