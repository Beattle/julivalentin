...
/*	if ($.browser.msie) {
    ...
    $(".right-column article#article, section.category-content,#content.article .article-info").mCustomScrollbar({
        theme:"dark-3",
        mouseWheel:{
            enable: true,
            preventDefault: true,
...
window.onload = function(){
    ...
    function adapt_img(){
        ...
        $('.center #banner4 img, .center #banner5 img, .center #banner6 img').imageScale({
            scale:'best-fill'
        });
    }
