...
!function (e) {
    e.fn.imageScale = function (a) {
        return this.each(function () {
            var b = e(this), c = b.data("imageScale");
            if (!c) {
                b.css("opacity", 0);
                var g = b[0].complete, f = e.extend({}, e.fn.imageScale.defaults, "object" == typeof a && a), h = function () {
    ...
    e.fn.imageScale.defaults = {scale: "best-fill", align: "center", parent: null, hideParentOverflow: !0, fadeInDuration: 0, rescaleOnResize: !0, callback: null, debug: 0};
    var l = function (a, b) {
        this.options = b;
        this.element = a;
        this.$element = e(a);
    ...
    l.prototype = {NONE: "none", FILL: "fill", BEST_FILL: "best-fill", BEST_FIT: "best-fit", BEST_FIT_DOWN_ONLY: "best-fit-down",
        ALIGN_LEFT: "left", ALIGN_RIGHT: "right", ALIGN_CENTER: "center", ALIGN_TOP: "top", ALIGN_BOTTOM: "bottom", ALIGN_TOP_LEFT: "top-left", ALIGN_TOP_RIGHT: "top-right", ALIGN_BOTTOM_LEFT: "bottom-left", ALIGN_BOTTOM_RIGHT: "bottom-right", constructor: l, scale: function (a) {
            if (!this._isDestroyed) {
                var b = this.options, c = this.$parent, g = this.$element;
                a && (b.hideParentOverflow && c.css({overflow: "hidden"}), g.css({opacity: 1}));
                this._didScheduleScale = !1;
                if (!b.rescaleOnResize || this._needUpdate()) {
                    var f = c.outerWidth(), h = c.outerHeight(),
                        e = c.innerWidth(), c = c.innerHeight(), e = f - e, c = h - c, k = g.attr("data-scale"), d = g.attr("data-align"), k = k ? k : b.scale, l = d ? d : b.align, d = b.fadeInDuration;
                    if (k) {
                        ...
                        var m = this.elementWidth, n = this.elementHeight;
                        f && h && m && n ? (this._cacheDestWidth = f, this._cacheDestHeight = h, b = this._innerFrameForSize(k, l, m, n, f, h), e && (b.x -= e / 2), c && (b.y -= c / 2), g.css({position: "absolute",
                            top: b.y + "px", left: b.x + "px", width: b.width + "px", height: b.height + "px", "max-width": "none"}), a && d && (g.css({display: "none"}), g.fadeIn(d))) : 0 < b.debug && console.error("imageScale - DEBUG ERROR: The dimensions are incorrect: source width: '" + m + "' - source height: '" + n + "' - dest width: '" + f + "' - dest height: '" + h + "'.")
        ...
        }, _cacheDestWidth: null, _cacheDestHeight: null, _lastWindowSize: null, _didScheduleScale: null}
}(window.jQuery);